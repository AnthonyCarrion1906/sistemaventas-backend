...
// NOTA: Este backend actúa como CONSUMIDOR de tokens JWT.
// Los tokens son generados por el servicio externo de autenticación (core-user-management-service).
// El endpoint de login local ha sido deshabilitado para evitar conflictos.
...
public class AuthController {
    ...
    // --- Dependencias deshabilitadas: solo se usaban para generar tokens localmente ---
    // Este servicio NO genera tokens; los valida a partir de los emitidos por el auth-service externo.
    ...
    // ---------------------------------------------------------------------------------
    // ENDPOINT DESHABILITADO: Generación de token de autenticación local
    // ---------------------------------------------------------------------------------
    // Este endpoint fue reemplazado por el auth-service externo (core-user-management-service),
    // que es el único responsable de emitir tokens JWT. Este backend solo los consume y valida.
    // ---------------------------------------------------------------------------------
    // @PostMapping("/login")
